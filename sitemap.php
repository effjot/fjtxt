...
<div class="hfeed">
  ...
  <div id="post-<?php the_ID(); ?>" class="<?php blogtxt_post_class() ?>">
    ...
    <?php
      if (get_post_custom_values('authorlink'))
        printf(__('<div class="author-meta">By %1$s</div>', 'blogtxt'), blogtxt_author_link());
    ...
    <div class="entry-content">
      ...
      <ul id="sitemap-page" class="xoxo">
        ...
        <li id="all-posts">
          ...
          <ul>
            <?php
              $post_archives = new wp_query('showposts=1000');
              while ($post_archives->have_posts()) :
                $post_archives->the_post();
            ?>
            <li class="hentry">
      ...
      <?php
        ...
        edit_post_link(__('Edit this entry.', 'blogtxt'),
  ...
  <?php
    if (get_post_custom_values('comments'))
      comments_template(); // Add a key/value of "comments" to load comments on a page
  ?>
