...
<?php link_pages('<div class="page-link">'.__('Pages: ', 'blogtxt'), "</div>\n", 'number'); ?>
					...
					<div class="entry-meta">
						...
						<span class="entry-date"><?php /* _e('Posted', 'blogtxt') */ ?><abbr class="published" title="<?php the_time('Y-m-d\TH:i:sO'); ?>"><?php unset($previousday); printf(__('%1$s', 'blogtxt'), the_date('', false)) ?></abbr></span>
