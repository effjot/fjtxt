  ...
  <ul>
    ...
    <?php
      if (!function_exists('dynamic_sidebar') || !dynamic_sidebar(1)) :
        // Begin Widgets for Sidebar 1; displays widgets or default contents below
    ...
    <?php
            ...
            echo '<li id="blogtxt-recent-comments"><h3>' .
              __('No Comments Yet', 'blogtxt') . '</h3></li>';
          endif; // comments
        endif; // is_home
  ...
  <ul>
    ...
    <?php
      if (!function_exists('dynamic_sidebar') || !dynamic_sidebar(2)) :
        // Begin Widgets for Sidebar 2; displays widgets or default contents below
        if (is_home() || is_category() || is_tag()) :
          // Displays category archives on the home and category pages
    ?>
    <li id="categories">
    ...
    <li id="meta">
      ...
      <ul>
        <li id="copyright">
          &copy; <?php echo(date('Y')); ?> <?php blogtxt_admin_hCard(); ?>
        </li>
        <li id="generator-link">
          <?php _e('Powered by <a href="http://wordpress.org/" title="WordPress" rel="generator">WordPress</a>', 'blogtxt') ?>
        </li>
        <li id="web-standards">
    ...
    <?php
        elseif (is_date()) :
          // Displays monthly archives on date-based archive pages
    ?>
    <li id="archives">
    ...
    <?php
        elseif (is_author()) :
          // Displays author archives on author archvies
    ?>
    <li id="authors">
    ...
    <li id="search">
      ...
      <form id="searchform" method="get" action="<?php echo home_url() ?>">
        <div>
          ...
          <input id="searchsubmit" name="searchsubmit" type="submit"
                 value="<?php _e('Find', 'blogtxt') ?>" />
        </div>
      </form>
    </li>
