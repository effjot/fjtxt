...
<html xmlns="http://www.w3.org/1999/xhtml" <?php if ( !function_exists('language_attributes') || language_attributes() ) _e('xml:lang="en-us" lang="en-us"', 'blogtxt'); ?>>
...
<?php rewind_posts() ?>
			...
			<div class="access">
				<span class="content-access"><a href="#content" title="<?php _e('Skip to content', 'blogtxt'); ?>"><?php _e('Skip to content', 'blogtxt'); ?></a></span>
			</div>
